...
import com.common.bean.NetworkStateReceiver;
...
public class AddDeviceStep1 extends Activity{
    private MainMenuButton _addDeviceStep1Back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _self = this;
        _addDeviceStep1Back=(MainMenuButton)findViewById(R.id.add_device_step1_back);
