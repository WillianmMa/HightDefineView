...
import com.common.selfdefineview.ProcessingView;
...
public class AddDeviceStep3 extends Activity{
    private MainMenuButton _addDeviceStep3Back;
    private ProcessingView _addDeviceStep3Process;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _addDeviceStep3Back=(MainMenuButton)findViewById(R.id.add_device_step3_back);
        _addDeviceStep3Back.setOnClickListener(_addDeviceStep3Back_Click);
        _addDeviceStep3Process=(ProcessingView)findViewById(R.id.add_device_step3_progress);
