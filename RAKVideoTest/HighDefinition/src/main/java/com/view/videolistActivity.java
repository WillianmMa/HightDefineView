...
{   
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		title_photolist.setText(getApplication().getString(R.string.video_text));
	...
	/*********************************************************************************************************
	  ...
	  ********************************************************************************************************/
	 	public static void AddListItem(int photo,String data, int chek)
	 	{
	 		...
	 		{
				map.put("date", "");
	 			map.put("photo", R.drawable.video_media_list);
			}
	 	...
	 	OnItemClickListener list_item_clik = new OnItemClickListener()
	 		{
	 			...
	 			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3)
	 			{
					...
					if(video_del_mode)
					{
						...
						photodelete.setText(getApplication().getString(R.string.delete_text)+"("+video_del_num+")");
					}
					else
					{
